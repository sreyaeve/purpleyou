...
clear 
    ...
    echo -e "${PURPLE}╘════════════════════════════════════════════╛\033[0m"
echo -e "\e[34m OS            \e[0m:  "`hostnamectl | grep "Operating System" | cut -d ' ' -f5-`
...
echo -e "\e[34m  Nginx Status \e[0m= $sttsnginx  \e[34m     Xray Status \e[0m= $sttsxray "
echo -e "${RED}└────────────────────┘${NC}  ${RED}└────────────────────┘${NC}"
	  echo -e "${PURPLE}╒════════════════════════════════════════════╕\033[0m"
...
echo -e " [\e[34m 10 \e[0m] Reboot VPS"
echo -e   ""
echo -e " [\e[34m 77 \e[0m] Clear RAM Cache"
echo -e " [\e[34m 88 \e[0m] Clear Log Xray"
echo -e   ""
echo -e   " Press x or [ Ctrl+C ] • To-Exit-Script"
echo -e   ""
    echo -e "${PURPLE}╒════════════════════════════════════════════╕\033[0m"
    echo -e " \E[0;41;36m         MINI AUTOSCRIPT XRAY ONLY          \E[0m"
    echo -e "${PURPLE}╘════════════════════════════════════════════╛\033[0m"
echo -e "\e[34mExpired         \e[0m: LIFETIME"
